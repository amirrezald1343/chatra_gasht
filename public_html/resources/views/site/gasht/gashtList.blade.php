                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            ...
                            <form action="{{ url('gashts') }}" method="get" id="form-search-tour" class="order-form filter-form filter-form-slider " data-animation="fadeInUp" data-timeout="1000">
                                <div class="form-row formFilterTop">
                                    <div class="form-group col-md-7">
                                        <v-select :options="options" @search="onSearch" dir="rtl" label="title_fa" v-model="value_destination_tour" placeholder="مقصد را وارد کنید" v-init:value_destination_tour="{ id: '{{   @json_decode(@$destinationBack)->id ?? @json_decode(@$destinationBack)->id   }}', title_fa: '{{ @json_decode(@$destinationBack)->title_fa ?? @json_decode(@$destinationBack)->title_fa }}' }">
                                    ...
                                    <div class="form-group col-md-4 p-relative">
                                        <date-picker value="@isset($monthNumber) {{$monthNumber}} @endisset" initial-value="" display-format="jYYYY/jMM/jDD" :auto-submit="true" locale="fa" name="start_in" placeholder="انتخاب روز" type="date" color="#ffd903"></date-picker>
                                    ...
                                    <li class="tourListItem">
                                        <div class='row'>
                                            ...
                                            <div class='col-lg-3 col-md-3 col-sm-4 col-12 tld'>
                                                ...
                                                <br>
                                                <a href="{{"https://worldfly.ir/fa/gashtDetails/".$value->id}}">
                                                    {{"worldfly.ir"}}
                                                </a>
                                            ...
                                            <div class='col-lg-3 col-md-3 col-sm-12 col-12 tld'>
                                                ...
                                                <i class="fa fa-dollar"></i> قیمت بزرگسال : {{number_format($value->adult)}} تومان
                                                <br>
                                                <i class="fa fa-dollar"></i> قیمت خردسال : {{number_format($value->price)}} تومان
                                                <br>
                                                <a href="" ></a>
                                            </div>
                                        </div>
                                ...
                                <div class="pagination">
                                    <ul class="pagination">
                                        ...
                                        @for ($i = 1; $i <= $gashts->lastPage(); $i++)
                                            <li class=" page-item ">
                                                <a class="{{ ($gashts->currentPage() == $i) ? ' active' : '' }}" href="{{  $gashts->url($i) }}">{{ $i }}</a>
                                            </li>
                                        @endfor
