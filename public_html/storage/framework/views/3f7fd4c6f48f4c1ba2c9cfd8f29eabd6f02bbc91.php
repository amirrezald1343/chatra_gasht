<?php $__env->startSection('meta'); ?>
    ...
    <link href="<?php echo e(url("css/site/scss/style.css")); ?>" rel="stylesheet">
    ...
    <main id="index">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="tab-pane active show  pr-3 pr-md-0  pl-3 pl-md-0 " id="flight">
                                            <form  @click="formFlightIndex"   action="<?php echo e(url('flights')); ?>" method="get" class="order-form filter-form filter-form-slider ">
                                                        ...
                                                        <div class="col-md-5 col-lg-4  pl-md-1">
                                                            <div class="form-group">
                                                                <v-select
                                                                    ...
                                                                    :options="[<?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citykey=>$cityvalue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        { countryCode: '<?php echo e($cityvalue); ?>', countryName: '<?php echo e($citykey); ?>' },
                                                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]"
                                                                    dir="<?php echo e($dir); ?>"
                                                                    placeholder="<?php echo e(__('flight.From')); ?>"
                                                                    :components="{DeselectFlight}"
                                                                    v-model="from_city_flight"
                                                                    <?php if(old('fromCityFlight')): ?> v-init:from_city_flight="{ countryCode: '<?php echo e(old('fromCityFlight')); ?>', countryName: '<?php echo e(array_flip($cities)[old('fromCityFlight')]); ?>' }"
                                                                    <?php endif; ?>
                                                                    label="countryName"
                                                                    v-cloak
                                                                >
                                                <span slot="no-options"
                                                      class="no-found-search"><?php echo e(__('flightb.No cities found')); ?></span>
                                                                </v-select>
                                                                <input name="fromCityFlight"
                                                                       type="hidden"
                                                                       v-model="fromCityFlightCode">
                                                                <?php echo getError($errors,'fromCityFlight'); ?>
                                                        ...
                                                        <div  class="col-md-5 col-lg-4 pr-md-1">
                                                            <div class="form-group" id="to_city_flight">
                                                                <v-select
                                                                    :options="
                                                            [<?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citykey=>$cityvalue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        { countryCode: '<?php echo e($cityvalue); ?>', countryName: '<?php echo e($citykey); ?>' },
                                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]"
                                                                    placeholder="<?php echo e(__('flight.To')); ?>"
                                                                    :components="{DeselectFlight}"
                                                                    dir="<?php echo e($dir); ?>"
                                                                    v-model="to_city_flight"
                                                                    <?php if(old('fromCityFlight')): ?> v-init:to_city_flight="{ countryCode: '<?php echo e(old('toCityFlight')); ?>', countryName: '<?php echo e((old('toCityFlight')) ?  array_flip($cities)[old('toCityFlight')] :''); ?>' }"
                                                                    <?php endif; ?>
                                                                    label="countryName"
                                                ...
                                                <span slot="no-options"
                                                      class="no-found-search"><?php echo e(__('flightb.No cities found')); ?></span>
                                                                ...
                                                                <?php echo getError($errors,'toCityFlight'); ?>
                                                        ...
                                                        <div class="col-md-5 col-lg-3  ivi3calendar pr-md-0 ">
                                                            <div id="flight-date-start"  class="form-group flightDateReturn" >
                                                                <input type="hidden" v-model="start_date_form_flight"  v-init:start_date_form_flight="'<?php echo e(old('fromDateFlight')); ?>'" />
                                                                <date-picker
                                                                    ...
                                                                    :color="color"
                                                                    locale="fa,en"
                                                                    placeholder="<?php echo e(__('flight.From Date')); ?>"
                                                                    id="flight-date"
                                                                    min="<?php echo e(Morilog\Jalali\Jalalian::now()->format('Y/m/d H:i')); ?>"
                                                                    name="fromDateFlight"
                                                                    v-cloak
                                                                ></date-picker>
                                                                <?php echo getError($errors,'fromDateFlight'); ?>
                                    ...
                                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        ...
                                        <form action="<?php echo e(url('Tours')); ?>" method="get" id="form-search-tour"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <v-select :options="optionsb" @search="onSearch" dir="rtl" label="title_fa"
                                                              ...
                                                              <?php if(old('destination') and old('destination') !='null' ): ?> v-init:value_destination_tour="{ id: '<?php echo e(json_decode(old('destination'))->id); ?>', title_fa: '<?php echo e(json_decode(old('destination'))->title_fa); ?>' }" <?php endif; ?>>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="owl-carousel">
                            <?php $__currentLoopData = $ToursSpecials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-12 col-lg-12 col-sm-12">
                                    <div class="tour-item">
                                        <a target="_blank" href="<?php echo e(url('Tour/'.$value->id).'/'.$value->title); ?>">
                                            <div class="img-wrap">

                                                <?php if(@$value->imageThumb): ?>
                                                    <img src=" <?php echo e(url($value->imageThumb)); ?> " alt="<?php echo e($value->title); ?>">
                                                <?php else: ?>
                                                    <img src="img/distination-3.jpg" alt="<?php echo e($value->title); ?>">
                                                <?php endif; ?>
                                                <p class="price font10">
                                                    <?php if(count($value->prices) > 1): ?>
                                                        <?php
                                                            $min=0;
                                                        ?>
                                                        <?php $__currentLoopData = $value->prices ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyPrice=>$valuePrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                        ...
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($min > 0): ?>
                                                            شروع قیمت از <?php echo e(number_format($min)); ?> تومان
                                                            <?php if(isset($dollar)): ?>
                                                                + <?php echo e($dollar); ?> <?php echo e(@config('defines.currency')[@$currencyMoment]); ?>

                                                            <?php endif; ?>
                                                        <?php else: ?>
                                                            تماس جهت قیمت
                                                        <?php endif; ?>
                                                    <?php elseif(count($value->prices) == 1): ?>
                                                        <?php if($value->prices[0]->price > 0): ?>
                                                            شروع قیمت از <?php echo e(number_format($value->prices[0]->price)); ?>

                                                            تومان
                                                        <?php else: ?>
                                                            تماس جهت قیمت
                                                        <?php endif; ?>
                                                        <?php if(@$value->prices[0]->price_dollar and $value->prices[0]->price > 0): ?>
                                                            +
                                                            <i><?php echo e(@$value->prices[0]->price_dollar); ?> <?php echo e(@config('defines.currency')[@$value->prices[0]->currency]); ?> </i>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        تماس جهت قیمت
                                                    <?php endif; ?>
                                        ...
                                        <div class="caption text-right">
                                            <a target="_blank" href="<?php echo e(url('Tour/'.$value->id).'/'.$value->title); ?>"
                                               class="titletour">
                                                <p class="title font15 text-center "><?php echo e($value->title); ?> </p>
                                            </a>
                                            <div class="row details">
                                                <div class="col-6 colsafar">
                                                    <p class="title ttype font-size-xs   text-center">
                                                        <?php if(getTravelMethod($value->travel_method)=='هوایی'): ?>
                                                            <i class="fa fa-plane "></i>
                                                        <?php elseif(getTravelMethod($value->travel_method)=='زمینی'): ?>
                                                            <i class="fa fa-car "></i>
                                                        <?php else: ?>
                                                            <i class="fa fa-ship "></i>
                                                        <?php endif; ?>
                                                        روش سفر
                                                        : <?php echo e(getTravelMethod($value->travel_method)); ?> </p>
                                                </div>
                                                <div class="col-6 colmabda">
                                                    <p class="title tfirst font-size-xs   text-center">
                                                        <i class="fa fa-map "></i>
                                                        مبدا
                                                        : <?php echo e($value->city->title_fa); ?> </p>
                                                </div>
                                            </div>

                                            <p class="date text-center"> <?php echo e(\Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($value->start_in))); ?>

                                                <i class="ti-calendar clnd"></i>
                                            </p>

                                            <p class="time text-center"><span
                                                    class="float-right ti-time p-1 mr-0"></span> <?php echo e($value->number_nights); ?>
                    ...
                    <div class="index-list-div">
                        ...
                        <div class=" tab-content" id="myTabContent">
                            ...
                            <div class="col-lg-12 tab-pane fade active show" id="internal" role="tabpanel"
                                ...
                                <div class="row">
                                    <?php $__currentLoopData = $ToursInternal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowInetrnal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 coltourdiv">
                                            <a href="/Tour/<?php echo e($rowInetrnal->id); ?>/<?php echo e($rowInetrnal->title); ?>">
                                                <div class="Tourdiv">
                                                    <div class="imgitm">
                                                        <?php if(@$rowInetrnal->imageThumb): ?>
                                                            <img src=" <?php echo e(url($rowInetrnal->imageThumb)); ?> "
                                                                 alt="<?php echo e($rowInetrnal->title); ?>">
                                                        <?php else: ?>
                                                    ...
                                                    <div class="captiondiv" style="padding-right:4px; padding-left:3px">
                                                        ...
                                                        <div class="" style="padding:0px; width:100%; margin-top:-12px; height:50px">
                                                            <div class="" style=" display:inline-block;width:52% ;margin-bottom:20px">
                                                                <h6 class="tour-title" style="; width:95%; line-height:2;padding-right:3px ">
                                                                    <i class="fa fa-map-marker"></i> <?php echo e($rowInetrnal->title); ?>
                                                            ...
                                                            <div style="display:inline-block;width:46%; float:left ; margin-top:-5px">
                                                                <div class="pricediv" style="; padding:0px;width:100%; float:left;text-align:left"><i class="fa fa-dollar"></i>
                                                                    <?php if(count($rowInetrnal->prices) > 1): ?>
                                                                        <?php
                                                                            $min=0;
                                                                        ?>
                                                                        <?php $__currentLoopData = $rowInetrnal->prices ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyPrice=>$valuePrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php
                                                                                $price=$valuePrice->price +($valuePrice->price_dollar * 13000);
                                                                                if($keyPrice == 0) $min=$price;
                                                                                if($price < $min ) $min=$price; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        شروع
                                                                        قیمت
                                                                        از <?php echo e(number_format($min)); ?>

                                                                        تومان <?php elseif(count($rowInetrnal->prices) == 1): ?>
                                                                        شروع قیمت
                                                                        از <?php echo e(number_format($rowInetrnal->prices[0]->price + ($rowInetrnal->prices[0]->price_dollar * 13000))); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div style="padding-right:3px">
                                                                    <i class="fa fa-calendar-check-o"></i> <?php echo e($rowInetrnal->number_nights); ?>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="clnder">
                                                                    <i class="fa fa-calendar"></i> <?php echo e(\Morilog\Jalali\CalendarUtils::strftime('Y/m/d', ($rowInetrnal->start_in))); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="typtravel">
                                                                    <i class="fa fa-building"></i> <?php echo e($rowInetrnal->agency->company); ?>
                            ...
                            <div class="col-lg-12 tab-pane fade" id="foreign" role="tabpanel"
                                 aria-labelledby="profile-tab">
                                <div class="row">
                                    <?php $__currentLoopData = $ToursForeign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowInetrnal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-12 tab-pane fade" id="lastsecond" role="tabpanel"
                                 aria-labelledby="profile-tab">
                                <div class="row">
                                    <?php $__currentLoopData = $ToursMoment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowInetrnal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="main-block" id="ToursMoment">
            <div class="container container-sm">
                ...
                <div class="row">
                    <div class="owl-carousel">
                        <?php $__currentLoopData = $TourIndoors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowIndoors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-12 col-lg-12 col-sm-12 boomgardi">
                                <div class="tour-item">
                                    <a target="_blank" href="<?php echo e(url('Tour/'.$rowIndoors->id).$rowIndoors->title); ?>">                                        <div class="img-wrap">
                                            <?php if(@$rowIndoors->imageThumb): ?>
                                                <img src="<?php echo e(url($rowIndoors->imageThumb)); ?>"
                                                     alt="<?php echo e($rowIndoors->title); ?>">
                                            <?php else: ?>
                                                <img src="img/distination-3.jpg" alt="<?php echo e($rowIndoors->title); ?>">
                                            <?php endif; ?>
                                            <p class="price font10">
                                                <?php if(count($rowIndoors->prices) > 1): ?>
                                                    <?php
                                                        $min=0;
                                                    ?>
                                                    <?php $__currentLoopData = $rowIndoors->prices ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyPrice=>$valuePrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $price=$valuePrice->price +($valuePrice->price_dollar * 13000);
                                                            if($keyPrice == 0) $min=$price;
                                                            if($price < $min ) $min=$price; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> شروع
                                                    قیمت
                                                    از <?php echo e(number_format($min)); ?>

                                                    تومان <?php elseif(count($rowIndoors->prices) == 1): ?>
                                                    شروع قیمت
                                                    از <?php echo e(number_format($rowIndoors->prices[0]->price + ($rowIndoors->prices[0]->price_dollar * 13000))); ?>
                                    ...
                                    <div class="caption text-right">
                                        <a target="_blank" href="<?php echo e(url('Tour/'.$rowIndoors->id).$rowIndoors->title); ?>">
                                            <p class="title font15 text-center"><?php echo e($rowIndoors->title); ?> </p>
                                        </a>
                                        <div class="row details">
                                            <div class="col-6 colsafar">
                                                <p class="title ttype font-size-xs   text-center">
                                                    <?php if(getTravelMethod($rowIndoors->travel_method)=='هوایی'): ?>
                                                        <i class="fa fa-plane "></i>
                                                    <?php elseif(getTravelMethod($rowIndoors->travel_method)=='زمینی'): ?>
                                                        <i class="fa fa-car "></i>
                                                    <?php else: ?>
                                                        <i class="fa fa-ship "></i>
                                                    <?php endif; ?>
                                                    روش سفر
                                                    : <?php echo e(getTravelMethod($rowIndoors->travel_method)); ?> </p>
                                            </div>
                                            <div class="col-6 colmabda">
                                                <p class="title tfirst font-size-xs   text-center">
                                                    <i class="fa fa-map "></i>
                                                    مبدا
                                                    : <?php echo e($rowIndoors->city->title_fa); ?> </p>
                                            </div>
                                        </div>

                                        <p class="date text-center"> <?php echo e(\Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($rowIndoors->start_in))); ?>

                                            <i class="ti-calendar clnd"></i>
                                        </p>

                                        <p class="time text-center"><span
                                                class="float-right ti-time p-1 mr-0"></span> <?php echo e($rowIndoors->number_nights); ?>
                    ...
                    <div class="col-lg-6 col-lg-6 mb-20">
                        ...
                        <a class="mb-20 android-googleplay-btn" target="_blank"
                           href="https://play.google.com/store/apps/details?id=com.it.mahab.clicksafar">
                            <img class="paralleximg " src="<?php echo e(url("/img/google-play-badge-3.png")); ?>"/>
                        </a>
                        <a class="mb-20 android-googleplay-btn" target="_blank"
                           href="https://cafebazaar.ir/app/com.it.mahab.clicksafar">
                            <img class="paralleximg " src="<?php echo e(url("/img/bazar2.png")); ?>"
            ...
            <div class="container container-sm">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <?php $__currentLoopData = $FavoriteTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowFav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12   dltr">
                                <div class="category-item effect-2">
                                    <img src="<?php echo e($rowFav['image']); ?>" alt="<?php echo e($rowFav->countries['title_fa']); ?>">

                                    <div class="caption text-right">
                                        <div>
                                            <p class="title font15"><?php echo e($rowFav->countries['title_fa']); ?></p>
                                            <p class="description"><?php echo e(strip_tags($rowFav['details'])); ?></p>
                                        </div>
                                        <a href="/Tours/destination/<?php echo e($rowFav['origin']); ?>">جزییات بیشتر</a>
                                    </div>
                            ...
                            <?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-12 col-lg-12 col-sm-12">
                                    <div class="tour-item2">
                                        <a target="_blank" href="<?php echo e(url('Tour/'.$post->id).'/'.$post->title); ?>">
                                            <div class="img-wrap">

                                                <?php if($post->image_thumb): ?>
                                                    <img src=" <?php echo e(url($post->image_thumb)); ?> " alt="<?php echo e($post->title); ?>">
                                                <?php else: ?>
                                                    <img src="img/distination-3.jpg" alt="<?php echo e($post->title); ?>">
                                                <?php endif; ?>
                                        ...
                                        <div class="caption2 text-right">
                                            <div class="row details">
                                                <div class="col-12 coltit">
                                                    <a href="<?php echo e(str_replace(' ','-',url('/blog/'.$post->id.'/'.$post->title))); ?>">
                                            ...
                                            <div>
                                                <a   class="btn btn-block buttdark" href="<?php echo e(str_replace(' ','-',url('/blog/'.$post->id.'/'.$post->title))); ?>">
        ...
        <nav class="social">
            <ul>
                ...
                <li><a href="https://www.aparat.com/clicksafar/"> <i class="fa"><img src="<?php echo e(url('img/aparat.png')); ?>" width="20" height="20px" class="fa fa-facebook"></i>Aparat</a></li>
            </ul>
        </nav>
...
<?php echo $__env->make('site.layout.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clicksafar\resources\views/site/index.blade.php ENDPATH**/ ?>