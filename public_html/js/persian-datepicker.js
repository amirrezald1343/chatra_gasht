        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            // console.log('navigator switch ');
                 ...
                 * <div id="plotId" class="datepicker-plot-area datepicker-plot-area-inline-view">
                 ...
                 <div class="title"></div>
                 <div class="header-row">
                 <div class="header-row-cell">Ø·Â´</div>
                 <div class="header-row-cell">ØºÅ’</div>
                 <div class="header-row-cell">Ø·Â¯</div>
                 <div class="header-row-cell">Ø·Â³</div>
                 <div class="header-row-cell">Ø¹â€ </div>
                 <div class="header-row-cell">Ø¸Â¾</div>
                 ...
                 {{#hour.enabled}}
                 <div class="hour time-segment" data-time-key="hour">
                 <div class="up-btn" data-time-key="hour">Ã¢â€“Â²</div>
                 <input value="{{hour.title}}" type="text" placeholder="hour" class="hour-input">
                 <div class="down-btn" data-time-key="hour">Ã¢â€“Â¼</div>
                 </div>
                 <div class="divider">:</div>
                 {{/hour.enabled}}
                 {{#minute.enabled}}
                 <div class="minute time-segment" data-time-key="minute" >
                 <div class="up-btn" data-time-key="minute">Ã¢â€“Â²</div>
                 <input value="{{minute.title}}" type="text" placeholder="minute" class="minute-input">
                 <div class="down-btn" data-time-key="minute">Ã¢â€“Â¼</div>
                 </div>
                 <div class="divider second-divider">:</div>
                 {{/minute.enabled}}
                 {{#second.enabled}}
                 <div class="second time-segment" data-time-key="second"  >
                 <div class="up-btn" data-time-key="second" >Ã¢â€“Â²</div>
                 <input value="{{second.title}}"  type="text" placeholder="second" class="second-input">
                 <div class="down-btn" data-time-key="second" >Ã¢â€“Â¼</div>
                 </div>
                 <div class="divider meridian-divider"></div>
                 <div class="divider meridian-divider"></div>
                 {{/second.enabled}}
                 {{#meridian.enabled}}
                 <div class="meridian time-segment" data-time-key="meridian" >
                 <div class="up-btn" data-time-key="meridian">Ã¢â€“Â²</div>
                 <input value="{{meridian.title}}" type="text" class="meridian-input">
                 <div class="down-btn" data-time-key="meridian">Ã¢â€“Â¼</div>
                 </div>
                 {{/meridian.enabled}}
                 </div>
                 {{/enabled}}
                ...
                _createClass(PersianDateParser, [{
                    ...
                    value: function parse(inputString) {
                        ...
                        String.prototype.toEnglishDigits = function () {
                            var charCodeZero = 'ØºÂ°'.charCodeAt(0);
                            return this.replace(/[ØºÂ°-ØºÂ¹]/g, function (w) {
