                ...
                <table class="table table-striped" style="min-width: 765px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="display: inline-block" href="{{ route('admin.editPost', ['id' => $rows->id]) }}" class="list-icons-item" title="edit">
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer justify-content-center">
                                                ...
                                                <form action="{{ route('admin.deletePost', ['id' => $rows->id]) }}" method="POST">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
