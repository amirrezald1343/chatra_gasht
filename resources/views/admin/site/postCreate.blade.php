    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{ Form::open(['route'=>['admin.post.store'],'files'=>true,'method'=>'post','class'=>'form-horizontal']) }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-12">
                        ...
                        {{ Form::text('summary',null,['class'=>'form-control','placeholder'=> __('validation.required',['attribute'=>'چکیده متن'])]) }}
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-12">
                        ...
                        {{ Form::text('tags','null',['class'=>'form-control inputTagSelector','placeholder'=> __('validation.required',['attribute'=>'عنوان'])]) }}
                    ...
                    <div class="form-group col-md-6  col-6 col-sm-6">
                        ...
                        <v-select multiple :options="options" @search="onSearchTour" dir="rtl" label="title" v-model="value_continents_tour">
