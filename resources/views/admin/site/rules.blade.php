...
@section('content')
    ...
    <div class="row justify-content-center">
        {{ Form::open(['route'=>['admin.adminRulesUpdate'],'files'=>true,'method'=>'post','class'=>'form-horizontal w-100']) }}
                ...
                <div class="card-body">
                        ...
                        <div class="row w-100">
                            <div class="form-group col-md-12">
                                <label class="d-block" for="name"> متن قوانین <span
                                            class="required-input">*</span></label>
                                <textarea required="required" class="summernote"
                                          name="description">{{$model['body']}}</textarea>
