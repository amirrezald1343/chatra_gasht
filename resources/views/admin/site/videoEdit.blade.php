    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{ Form::open(['route'=>['admin.video.update',$video->id],'files'=>true,'method'=>'post','class'=>'form-horizontal']) }}

                <div class="row">

                    <div class="form-group col-md-6 col-sm-6 col-12">
                        <label for="name">عنوان : <span class="required-input">*</span> </label>
                        {{ Form::text('title',$video->title,['class'=>'form-control','placeholder'=> __('validation.required',['attribute'=>'عنوان'])]) }}
                        {!! getError($errors,'title') !!}
                    </div>

                    <div class="form-group col-md-6 col-sm-6 col-12">
                        <label for="name">آدرس فایل : <span class="required-input">*</span> </label>
                        {{ Form::text('url',$video->url,['class'=>'form-control','placeholder'=> __('validation.required',['attribute'=>'آدرس فایل'])]) }}
                        {!! getError($errors,'url') !!}
                    </div>

                    <div class="form-group col-md-12 col-sm-12 col-12">
                        <label class="d-block" for="name">متن : <span class="required-input">*</span></label>
                        {{ Form::textarea('body',$video->body,['class'=>'ckEr','']) }}
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-12">
                        ...
                        <img src='{{url("/$video->image_thumb")}}' style="width:300px;height:250px;" />
                        @endif
                    </div>
...
<script>
    ...
    $(document).ready(function(e) {
        ...
        CKEDITOR.replace('body', {
            ...
            // removeModules: 'FormUpload,Html5Upload,'
        });
