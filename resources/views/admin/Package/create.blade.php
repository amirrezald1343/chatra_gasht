                    ...
                    <div class="row">
                        <div class="row w-100">
                            <div class="form-group col-md-6 col-6 col-sm-6">
                                ...
                                <v-select :required="selected" class="vs__search" :options="options" @search="onSearch" dir="rtl" label="title_fa" v-model="value_origin_tour">
                                ...
                                <input name="origin" type="hidden" class='hiddenInputs' v-model="valueOriginTour">
                                {!! getError($errors,'origin') !!}
                            </div>
                            <div class="form-group col-md-6  col-6 col-sm-6">
                                <label class="d-block" for="name">مقاصد تور (قاره)</label>
                                <v-select multiple :options="options" @search="onSearchContinent" dir="rtl" label="title_fa" v-model="value_continents_tour">
                                    <template slot="no-options">هیچ موردی یافت نشد.</template>
                                    <template slot="option" slot-scope="option">
                                        <div class="d-center">
                                            @{{ option.title_fa }}
                                ...
                                <input name="continents" type="hidden" v-model="valueContinentsTour">
                            ...
                            <div class="form-group col-md-6  col-6 col-sm-6">
                                ...
                                <v-select multiple :options="options" @search="onSearchCountry" dir="rtl" label="title_fa" v-model="value_countries_tour">
                                    <template slot="no-options">هیچ موردی یافت نشد.</template>
                                    <template slot="option" slot-scope="option">
                                        <div class="d-center">
                                            @{{ option.title_fa }}
                                ...
                                <input name="countries" type="hidden" v-model="valueCountriesTour">
                                {!! getError($errors,'countries') !!}
                            </div>
                            <div class="form-group col-md-6  col-6 col-sm-6">
                                <label class="d-block" for="name"> مقاصد تور (شهر) <span class="required-input">*</span>
                                </label>
                                <v-select multiple :options="options" @search="onSearch" dir="rtl" label="title_fa" v-model="value_cities_tour">
                                    <template slot="no-options">هیچ موردی یافت نشد.</template>
                                    <template slot="option" slot-scope="option">
                                        <div class="d-center">
                                            @{{ option.title_fa }}
                                ...
                                <input name="cities" type="hidden" class='hiddenInputs' v-model="valueCitiesTour">
                        ...
                        <div class="row w-100">
                            ...
                            <div class="form-group col-md-4 col-4 col-sm-4">
                                <label for="name">
                                    <span>لحظه آخری</span>
                                    <span class="help-tour" data-popup="tooltip" title="" data-original-title="با انتخاب این گزینه تور شما در لیست تور های لحظه آخری قرار داده خواهد شد">
                                    <i class="icon-help"></i>
                                </span>
                                </label>
                            ...
                            @can('isSuperAdmin',App\User::Class)
                                <div class="form-group col-md-4 col-4 col-sm-4">
                                    ...
                                    {!! form::checkbox('special',1,0,['class'=>'form-check-input-switchery']) !!}
...
" dir="rtl" label="title" v-model="value_service_tour">
                                    <template slot="no-options">هیچ موردی یافت نشد.</template>
                                    <template slot="option" slot-scope="option">
                                        <div class="d-center">
                                ...
                                <input name="services" type="hidden" v-model="valueServiceTour">
                            ...
                            <div id="maraheltour" class="form-group col-md-12">
                                ...
                                <div class="col-sm-6 mt-3">
                                    <div class="d-flex align-items-center  mb-2">
                                        <a href="#1" onclick="add_level()" class="   btn bg-transparent border-teal text-teal rounded-round border-2 btn-icon mr-2 legitRipple">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-4 col-4 col-sm-4">
                                    <label for="isOnline">فروش آنلاین
                                        ...
                                        <input type="checkbox" style="vertical-align: middle" name="isOnline" value="1" id="isOnline" class="isOnlineBtn">
                                ...
                                <div class="form-group col-md-4 col-4 col-sm-4">
                                    ...
                                    <input type="number" min=0 name="capacity" class="capacity form-control">
                                </div>
                                <br>
                                <div class="form-group col-md-12 col-12 col-sm-12">
                                    <label for="" class="d-block price_list">لیست قیمت 
                                        <i class="priceIsOnline"> برای فروش آنلاین قیمت اجباری می باشد </i> 
                                ...
                                <div class="col-sm-4 mt-3">
                                    <div class="d-flex align-items-center  mb-2">
                                        <a href="#1" onclick="add_price()" class="   btn bg-transparent border-teal text-teal rounded-round border-2 btn-icon mr-2 legitRipple">
                                            <i class="icon-plus3  "></i>
                                        </a>
                                        <div>
    ...
    <script>
        add_price = function() {
            ...
            var html = '<div id="price_' + count + '"   class="price  "  style="direction:rtl; margin-right:85px;margin-top:13px;position: relative">' +
                ...
                ' </div> ' +
                '<div> <span style="color: #888585;font-size: 11px;"> هر نفراستاندارد (تومان ) :</span> <input name="amount_price_package[]"   class="form-control amount_price_packages" style="width:160px;display: inline-block;margin-right: 31px;" type="number" > </div>' +
                '<div> <span style="color: #888585;font-size: 11px;"> قیمت هر نوزاد  (تومان):</span> <input name="amount_price_baby[]"   class="form-control amount_price_packages" style="width:160px;display: inline-block;margin-right: 31px;" type="number" > </div>' +
                '<div> <span style="color: #888585;font-size: 11px;"> قیمت زیر 5 سال (تومان) : </span> <input name="amount_price_LTF[]"   class="form-control amount_price_packages" style="width:160px;display: inline-block;margin-right: 31px;" type="number" > </div>' +
                '<div> <span style="color: #888585;font-size: 11px;"> قیمت 6 تا 14 سال  (تومان): </span> <input name="amount_price_BSF[]"   class="form-control amount_price_packages" style="width:160px;display: inline-block;margin-right: 31px;" type="number" > </div>' +
                ...
                <?php foreach (config('defines.currency') as $rowCu => $valCu) { ?> "<option value='<?php echo $rowCu ?>'>" + "<?php echo $valCu; ?>" + "</option>" +
                <?php } ?> '</select>' +
                '</div>';
