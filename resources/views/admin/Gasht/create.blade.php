        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div style="padding: 5px; width: 100%">
                    ...
                    <form method="post" action="{{route('admin.storeGasht')}}" enctype="multipart/form-data"
                          style=" width: 100%">
                    {{ csrf_field()  }}
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6  col-6 col-sm-6">
                                ...
                                <v-select :options="options" @search="onSearch" dir="rtl" label="title_fa"
                                          v-model="value_cities_tour_origin">
                            ...
                            <div class="form-group col-md-12  col-12 col-sm-12">
                                ...
                                <div class="price_container">
                                    ...
                                    <div class="price-item">
                                        ...
                                        <label>
                                            قیمت بزرگسال
                                            <input type="text" required class="form-control fee" min='0'
                                                   placeholder="تومان" name="adult[]">
                                        </label>

                                        <label>
                                            قیمت خردسال
                                            <input type="text" required class="form-control fee" min='0'
                                                   placeholder="تومان" name="child[]">
                                        </label>

                                        <label>
                                            ظرفیت
                                            <input type="number" required class="form-control" min='0'
                                                   placeholder="ظرفیت نفر" name="capacity[]">
                                        </label>

                                        <label>
                                            حداقل رزرو
                                            <input type="number" required class="form-control" min='0'
                                                   placeholder="ظرفیت نفر" name="minCount[]">
                                        </label>
                                        ...
                                        {{--<label>--}}
                                        {{--<input type="radio" class="option-input radio" name="typedate[]" value="all" checked='checked' />--}}
                                        {{--همه--}}
                                        {{--</label>--}}

                                        {{--<label>--}}
                                        {{--<input type="radio" class="option-input radio" name="typedate[]" value="zoj"  />--}}
                                        {{--زوج--}}
                                        {{--</label>--}}

                                        {{--<label>--}}
                                        {{--<input type="radio" class="option-input radio" name="typedate[]" value="fard" />--}}
                                        {{--فرد--}}
                                        {{--</label>--}}
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="col-lg-2">
                                                <select name="typedate[]" class="form-control select-fixed-single customWidths">
                                                    <option value="all">همه روزهای هفته</option>
                                                    <option value="zoj">روز های زوج</option>
                                                    <option value="fard">روز های فرد</option>
                                                </select>
                                            </div>

                                            <div class="col-lg-10">
                                                <div style="padding: 10px;width: 100%;text-align: right;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;margin: 0 auto;">
                                                    (به جز :  <input type="checkbox" name="expect[]"  value="شنبه" > شنبه
                                                    &nbsp;<input type="checkbox" name="expect[]"  value="  یک شنبه" >  یک شنبه
                                                    &nbsp;<input type="checkbox" name="expect[]"  value="دوشنبه" >  دوشنبه
                                                    &nbsp;  <input type="checkbox" name="expect[]"  value="سه شنبه" > سه شنبه
                                                    &nbsp; <input type="checkbox" name="expect[]"  value=" چهارشنبه" > چهار شنبه
                                                    &nbsp;<input type="checkbox" name="expect[]" value="پنجشنبه" >   پنجشنبه
                                                    &nbsp; <input type="checkbox" name="expect[]"  value="جمعه" > جمعه
                                                    )
                                                </div>
                                            </div>
                                        ...
                                        <span style=" float:left; font-size:13px; background-color:#3f51b5; padding:3px 5px 3px 5px;color:white; border-radius:4px;cursor:pointer"
                                              class="new-row-item-btn">جدید</span>

                                        <input type="hidden" value="4" id="numbdate">
...
@section('scripts')
    ...
    <script>
        ...
        $(".new-row-item-btn").click(function () {
            var numbdate = $("#numbdate").attr("value");
            numbdate++;
            $(".price_container").append("<div class='price-item'>" +
                ...
                "</label> &nbsp;" +
                "<label>  حداقل رزرو " +
                "<input required type='number' class='form-control' min='1' placeholder='ظرفیت  نفر' name='minCount[]'>" +
                "</label> &nbsp;" +
                "<label>   از تاریخ " +
                ...
                "</label>" +
                "<br><br><br><label for='radio-4" + numbdate + "' > " +
                "<label for='radio-4" + numbdate + "'  > " +
                "<select name='typedate[]' class='form-control select-fixed-single customWidths'>" +
