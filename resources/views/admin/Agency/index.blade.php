    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div style="padding: 5px; width: 100%">
                <form method="get" action="/admin/Agency" style=" width: 100%">
                    {{ csrf_field()  }}
                    ...
                    <div class="row">
                        <div class="form-group col-md-5  col-12 col-sm-12">
                            ...
                            <v-select
                                            ...
                                            @if($filterParams)
                                            v-init:value_agencies="{id:{{$filterParams}},company:'{{$filterParams}}'}"
                                            @endif
                                            >
                                ...
                                <div class="form-group col-md-6 col-12 col-sm-12">
                                    ...
                                    style="background-color: #1dad1d; color:white; border: none; padding: 6px 12px;
                                        margin-top: 30px; width: 30%; cursor: pointer;">
                                    <a href="/admin/Agency" style="background-color: #4961bb; color:white; border: none; padding: 5px 12px;
