...
/**
 * A fake ReflectionFunction but for Service constructs.
 */
class ReflectionLanguageConstruct extends \ReflectionFunctionAbstract
{
    ...
    public function __construct($keyword)
    {
        if (!self::isLanguageConstruct($keyword)) {
            throw new \InvalidArgumentException('Unknown Service construct: ' . $keyword);
        }
    ...
    /**
     * Gets the file name from a Service construct.
     *
    ...
    /**
     * Check whether keyword is a (known) Service construct.
     *
     * @param string $keyword
     *
     * @return bool
